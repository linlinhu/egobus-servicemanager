 ...
 * person window
 */
Emin.OPERATIONCONFIGSWindow = Ext.extend(Ext.app.Module, {
    id: 'OPERATIONCONFIGS-win',
    init: function () {
        this.launcher = {
            text: '运营配置',
            iconCls: 'icon-operationConfig',
    ...
    createWindow: function () {
        ...
        var win = desktop.getWindow('OPERATIONCONFIGS-win');
        if (!win) {
           ...
           var statusStore = new Ext.data.JsonStore({
               url: basePath + 'runtimeconfig/operation/modules',
               fields: ['code', 'desc'],
               baseParams:{
           ...
           statusStore.load();
            ...
            var operationConfigStore = new Ext.data.JsonStore({
                url: basePath + 'runtimeconfig/operation/module',
                ...
                listeners: {
                    ...
                    afteredit: function (e) {
                        ...
                        if (record.isValid()) {
                            ...
                            Ext.Ajax.request({
                                url: basePath + '/runtimeconfig/operation/update',
                                params: {
